...
if ($Catid != '') {
    $CattQry = "SELECT jet_node_id FROM mutual_category WHERE parent_id='" . $Catid . "'";
            ...
            <div class="category-main">
                ...
                <div class="category-right">
                    ...
                    <div class="category-box-main">
                        <? if ($pppttot > 0) { ?>
                            ...
                            ?>
                                <div class="category-box">
                                    <div class="category-img"> <? if ($image_url != '') { ?><a href="<?= $ItmUrl; ?>"><img src="<?= stripslashes($image_url); ?>" alt="<?= stripslashes($SelMovieObj->user_defined_sku_id); ?>, <?= stripslashes($SelMovieObj->product_title); ?>, <?= $siteALTTXT; ?>" title="<?= stripslashes($SelMovieObj->user_defined_sku_id); ?>, <?= stripslashes($SelMovieObj->product_title); ?>, <?= $siteALTTXT; ?>" /></a><? } else { ?><img src="noimg.jpg" alt="<?= stripslashes($SelMovieObj->user_defined_sku_id); ?>, <?= stripslashes($SelMovieObj->product_title); ?>, <?= $siteALTTXT; ?>" title="<?= stripslashes($SelMovieObj->user_defined_sku_id); ?>, <?= stripslashes($SelMovieObj->product_title); ?>, <?= $siteALTTXT; ?>"><? } ?> </div>

                                    <div class="category-img-detail" style="text-align: center;">
                                        <div class="category-img-title"><a href="<?= $ItmUrl; ?>"><?= stripslashes($tittl); ?></a></div>
                                        <span>SKU# <?= $SelMovieObj->user_defined_sku_id; ?></span><br>
                                        <span class="price">$<?= stripslashes($SelMovieObj->item_price); ?></span>
                                        <? if ($inventory > 0) { ?><div class="category-bottom-box"> <a href="<?= $ItmUrl; ?>">Add To Cart</a> </div><? } else { ?><div class="category-bottom-box"> <a href="#" onClick="return false;">Out of Stock</a> </div><? } ?>
                            ...
                            <div class="clear"></div>
                            <?
                            if ($pppttot > $ShowPage) { ?><div class="pagging"><? if ($PageNo > 1) {
                                                                                    $PrevPageNo = $PageNo - 1; ?><a href="<?= $PaginUrrl; ?>Page=<?= $PrevPageNo; ?>" class="butt">&laquo;<span class="mobpg"> Previous</span></a></li><? } ?>
                                    <? if ($PageNo <= 10) {
                        ...
                        <? } else { ?>
                            <div class="clear">&nbsp;</div>
                            <div class="clear" align="center" style="min-height:300px;"><strong>No matching records found.</strong></div>
                            <div class="clear">&nbsp;</div>
                        <? } ?>
                    </div>
                </div>
